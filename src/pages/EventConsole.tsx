    ...
    <div className="space-y-4 h-full flex flex-col">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-xl font-bold text-text-primary">Event Console</h1>
        </div>
      ...
      <div className="flex items-center gap-4">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 rounded-lg bg-white/5 border border-white/10 text-text-primary placeholder-text-secondary focus:outline-none focus:border-blue-500/50 transition-colors text-sm"
          />
        </div>
      ...
      <div className="flex-1 card overflow-hidden">
        <div className="h-full overflow-y-auto font-mono text-sm">
          {filteredLogs.map((log) => (
            ...
            >
              <span className="text-text-secondary text-xs w-20 flex-shrink-0">{log.time}</span>
              <span className="text-text-secondary text-xs w-16 flex-shrink-0">{log.module}</span>
      ...
      <div className="grid grid-cols-4 gap-4">
        <div className="card text-center">
          ...
          <p className="text-xl font-bold text-text-primary">{logs.length}</p>
        </div>
        <div className="card text-center">
